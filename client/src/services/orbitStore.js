...
const INITIAL_SPARKS = [
  ...
  },
  {
    ...
    statusTag: 'exploring',
    content: 'Just discovered an amazing hidden café downtown. The atmosphere is incredible.',
    constellationId: 'coffeebreak',
    constellationTag: '#CoffeeBreak',
    minsRemaining: 45,
    maxMins: 60,
    orbitRingIndex: 1,
    orbitRadiusX: 170,
  ...
  },
  {
    ...
    statusTag: 'building',
    content: 'Finally solved that memory leak issue after 3 hours of debugging! Pure relief.',
    constellationId: 'codingflow',
    constellationTag: '#CodingFlow',
    minsRemaining: 80,
    maxMins: 90,
    orbitRingIndex: 2,
    orbitRadiusX: 250,
  ...
  },
  {
    ...
    statusTag: 'creating',
    content: 'Painting the sunrise while it happens. The colors are indescribable today.',
    constellationId: 'deepspace',
    constellationTag: '#DeepSpace',
    minsRemaining: 15,
    maxMins: 30,
  ...
  },
  {
    ...
    statusTag: 'reading',
    content: 'Lost in a sci-fi novel. Escaping reality for a bit.',
    constellationId: 'solitude',
    constellationTag: '#SolitudeSynced',
    minsRemaining: 120,
    maxMins: 120,
